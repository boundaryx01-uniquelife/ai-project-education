...
$Checks = @(
    ...
    @{ Name = "Pinpoint revision page and revalidation loop"; Value = $Html.Contains('data-step="4"') -and $Html.Contains('revisionSourceSummary') -and $Html.Contains('revisionIssue') -and $Html.Contains('revisionOutcome') -and $Html.Contains('copyPinpointPrompt') -and $Html.Contains('savePinpointPlan') -and $Js.Contains('function pinpointPrompt') -and $Js.Contains('function startRevision') -and $Js.Contains('function savePinpointPlan') -and $Js.Contains('validationVersions') },
