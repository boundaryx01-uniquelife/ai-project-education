...
$Checks = @(
    ...
    @{ Name = "AI-guided revision and revalidation loop"; Value = $Html.Contains('improvementPrompt') -and $Html.Contains('copyImprovementPrompt') -and $Html.Contains('aiRevisionAdvice') -and $Html.Contains('revisionHistory') -and $Html.Contains('goToRevision') -and $Js.Contains('function improvementPrompt') -and $Js.Contains('function saveRevision') -and $Js.Contains('validationVersions') },
