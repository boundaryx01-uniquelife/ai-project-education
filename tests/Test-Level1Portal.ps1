...
$Checks = @(
 @{Name="Three-session guided practice";Value=$Html.Contains('data-progress="0"') -and $Html.Contains('data-progress="2"') -and $Js.Contains('const STAGES')},
 ...
 @{Name="Context-aware data-based MVP";Value=$Html.Contains('mvpChat') -and $Html.Contains('sendMvpQuestion') -and $Js.Contains('function findCard') -and $Js.Contains('continuation') -and $Js.Contains('let conversation')},
