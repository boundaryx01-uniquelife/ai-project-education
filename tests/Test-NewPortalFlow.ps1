...
$LevelActionsCss = Get-Content -LiteralPath (Join-Path $Root "portal\assets\level-actions.css") -Raw
...
$Checks = @(
    ...
    @{ Name = "Level cards use a unified practice and reference action system"; Value = $Portal.Contains("./assets/level-actions.css") -and $LevelActionsCss.Contains(".level-result > a") -and $LevelActionsCss.Contains(".practice-entry") -and $LevelActionsCss.Contains("font-family: inherit") },
